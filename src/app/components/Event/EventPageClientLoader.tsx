...
import { getSingleEvent } from "@/sanity/schemaTypes/queries"; // ✅ Ensure this is a GROQ string
...
export default function EventPageClientLoader({
  ...
  useEffect(() => {
    const fetchEvent = async () => {
      setLoading(true);
      try {
        const fetchedEvent = await client.fetch(getSingleEvent, {
          slug: eventSlug,
        });
            ...
            <div className="pt-[40px]">
                ...
                <div className="pb-[60px]">
                  ...
                  <div className="flex flex-col lg:flex-row gap-[24px]">
                    {event.galleryImages.map((photo: any, index: number) => (
                      <div
                        key={index}
                        className="w-full max-w-full sm:max-w-full md:max-w-full lg:max-w-full md:h-[200px] h-[160px] mx-auto rounded-[10px] overflow-hidden"
                      >
                        <Image
                          src={photo.url}
                          alt={event.title}
              ...
              {event.videos && event.videos.length > 0 && (
                <div className="pb-[96px]">
                  ...
                  <div className="flex flex-col md:flex-row lg:flex-row items-center justify-center gap-[24px]">
