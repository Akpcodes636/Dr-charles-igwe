...
const KingdomCard = ({
  ...
  return (
    <div className="w-full max-w-[358px] md:max-w-full lg:max-w-full mx-auto h-[357px] bg-[#EDF3FC] rounded-[5px]">
      <div className="p-[24px] flex flex-col h-full">
        ...
        <div className="flex-1 ">
          <h3 className="text-center text-[#000000] text-[20px] font-medium leading-[100%] space-y-[8px]">
            {title}
          </h3>
