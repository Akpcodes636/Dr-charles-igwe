...
const Hero = () => {
  ...
  return (
    <section className="relative bg-[url(/images/Hero-2.png)] sm:bg-[url(/images/Hero-1.jpg)] md:bg-[url(/images/Hero-1.jpg)] bg-cover bg-center lg:bg-bottom bg-no-repeat">
      ...
      <div className="relative z-10">
        <Header />
        <div className="container-sm pt-[40px] md:pt-[40px] pb-[39px] md:pb-[109px]">
          ...
          <div className="mb-[230px] sm:mb-[0px] md:mb-[0px]">
            {/* Desktop */}
