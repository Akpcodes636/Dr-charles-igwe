    ...
    <section>
      ...
      >
        ...
        <div className="py-[16px] md:py-[56px] lg:py-[96px]">
          <h3 className="text-[#FFFFFF] w-full max-w-[330px] md:max-w-full mx-auto text-center font-semibold text-[22px] md:text-[30px] lg:text-[38px] leading-[28px] md:leading-[100%] lg:leading-[100%] mb-[8px]">
          ...
          <p className="max-w-[330px] md:max-w-[500px] lg:max-w-full mx-auto w-full text-[#FFFFFF] text-center text-[14px] md:text-[16px] lg:text-[18px] leading-[20px] md:leading-[24px] lg:leading-[28px]">
            Helping organizations design, execute, and scale projects with
            clarity and impact.
          </p>
        </div>
      </div>
